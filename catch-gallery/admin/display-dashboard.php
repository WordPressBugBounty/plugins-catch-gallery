							...
							<tr>
								...
								<td>
									...
									<p class="description"><?php printf(
																// Translators: %1$sExif%2$s is a URL to wiki for a image file format
																esc_html__('Show photo metadata (%1$sExif%2$s) in carousel, when available', 'catch-gallery'),
																'<a href="http://en.wikipedia.org/wiki/Exchangeable_image_file_format" target="_blank" rel="nofollow">',
																'</a>'
															); ?></p>
								</td>
							</tr>
